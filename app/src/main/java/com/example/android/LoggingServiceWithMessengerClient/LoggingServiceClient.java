package com.example.android.LoggingServiceWithMessengerClient;
...
public class LoggingServiceClient extends Activity {
    ...
    private final static Intent mLoggingServiceIntent = new Intent(
            "com.example.android.LoggingServiceWithMessenger.LoggingService");
    ...
    private void logMessageToService() {
        ...
        bundle.putString(MESSAGE_KEY, "Log This Message-Messenger-SDPD");
        msg.setData(bundle);
